...
module.exports = fxsx = async (fxsx, mek) => {
	try {
        ...
        const ftroli ={"key": {   "fromMe": false,"participant":"0@s.whatsapp.net",   "remoteJid": "0@s.whatsapp.net"  }, "message": {orderMessage: {itemCount: 1,status: 200, thumbnail: fs.readFileSync('./stik/thumb.jpeg'), surface: 200, message: `${fake}\nHai ${pushname}`, orderTitle: 'NuyFaa', sellerJid: '0@s.whatsapp.net'}}}
...
buffer = await getBuffer('https://raw.githubusercontent.com/alonecans/foto-manca/main/me%20(1).jpg')
        	fxsx.sendMessage(from, buffer, image, {quoted: ftroli, contextInfo: { forwardingScore: 508, isForwarded: true, sendEphemeral: true, thumbnail: fs.readFileSync('./stik/thumb.jpeg', 'base64'),caption: menu})
           	break
    case 'on':
